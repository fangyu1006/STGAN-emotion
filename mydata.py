...
class Test(Dataset):
    ...
    def __init__(self, data_dir, atts_path, atts, img_resize, batch_size, prefetch_batch=2, drop_remainder=True,
                 num_threads=16, shuffle=True, buffer_size=4096, repeat=-1, sess=None, part='train', crop=True, im_no=None):
        super(Test, self).__init__()

        # list_file = '/home/iim/FY/STGAN/data/deepglint_attr_list.txt'
        list_file = atts_path
        '''
	if crop:
	...
	if os.path.exists(img_dir_png):
        ...
        att_id = [Test.att_dict[att] + 1 for att in atts]
	...
	'''
        ...
        if im_no is not None:
            ...
            #img_paths = img_paths[6100000:]
            #labels = labels[6100000:]
        elif part == 'val':
            img_paths = img_paths[6000000:6100000]
            labels = labels[6000000:6100000]
        else:
            img_paths = img_paths[:6000000]
            labels = labels[:6000000]
